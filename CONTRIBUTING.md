...
Welcome to `frua-base` contributor's guide.
...
If you experience bugs or general issues with `frua-base`, please have a look
...
You can help improve `frua-base` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`frua-base` documentation uses [Sphinx] as its main documentation compiler.
...
**This project uses [GooglePyStyle] and [Markdown].**
   ...
   :::{tip}
      ...
      propose changes in `frua-base`'s files. While this mechanism can
...
```
conda create -n base python=3 six virtualenv pytest pytest-cov
conda activate base
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/base.git
   cd base
   ```
