...
If you experience bugs or general issues with `base`, please have a look
...
You can help improve `base` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`base` documentation uses [Sphinx] as its main documentation compiler.
...
**This project uses [GooglePyStyle] and [Markdown].**
   ...
   :::{tip}
      ...
      propose changes in `base`'s files. While this mechanism can
